...
Conceitos basicos de metodos HTTP utilizando NodeJS

## :rocket: Sobre o desafio

Nesse desafio, a ideia e criar uma aplicação envolvendo metodos HTTP utilizando Node.js!
...
Caso você tenha dúvidas quanto ao que são os testes, e como interpretá-los, dé uma olhada no **[FAQ](https://github.com/Rocketseat/bootcamp-gostack-desafios/tree/master/faq-desafios).** da RocketSeat
